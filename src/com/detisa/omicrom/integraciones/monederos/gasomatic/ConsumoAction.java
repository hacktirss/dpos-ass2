...
import com.detisa.omicrom.integraciones.monederos.gasomatic.preset.ConsumoTarjetaGasoMatic;
...
public class ConsumoAction extends ConsumoActionBase {
    ...
    public ConsumoAction(DinamicVO<String, String> param) throws DetiPOSFault {
        ...
        consumo = new ConsumoTarjetaGasoMatic();
    }
    ...
    protected void initObserver() {
        ...
        ComandoObserver puntogasObserver = new ComandoObserver(
                new GasoMaticUpdater()
                        .setRequest(parameters)
                        .setAuth(((ConsumoTarjetaGasoMatic) consumo).getAuth()));
