...
import com.detisa.omicrom.integraciones.monederos.puntogas.preset.ConsumoTarjetaPuntoGas;
...
public class ConsumoAction extends ConsumoActionBase {
    ...
    public ConsumoAction(DinamicVO<String, String> param) throws DetiPOSFault {
        super(param);
        consumo = new ConsumoTarjetaPuntoGas();
    }
    ...
    protected void initObserver() {
        ...
        ComandoObserver puntogasObserver = new ComandoObserver(new PuntoGASUpdater().setRequest(parameters));
