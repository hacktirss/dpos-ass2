...
import com.detisa.omicrom.integraciones.monederos.yena.preset.ConsumoTarjetaYena;
...
public class ConsumoAction extends ConsumoActionBase {
    ...
    public ConsumoAction(DinamicVO<String, String> param) throws DetiPOSFault {
        super(param);
        consumo = new ConsumoTarjetaYena();
    }//Constructor
    ...
    protected void initObserver() {
        ...
        ComandoObserver yenaObserver = new ComandoObserver(
                new YenaUpdater()
                        .setRequest(parameters)
                        .setOrder(((ConsumoTarjetaYena) consumo).getOrder())
                        .setPayment(((ConsumoTarjetaYena) consumo).getPayment()));
        comando.register(yenaObserver);
        comando.initConsumo();
    }
}
