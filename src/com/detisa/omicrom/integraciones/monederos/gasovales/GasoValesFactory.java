...
public class GasoValesFactory {
    ...
    public static void main(String[] args) throws MalformedURLException, UnknownHostException, JsonProcessingException {
        ...
        V1Soap service = GasoValesFactory.getCardService("http://sigma.gruges.com.mx/ges.central.services.soap/v1.asmx?WSDL");
