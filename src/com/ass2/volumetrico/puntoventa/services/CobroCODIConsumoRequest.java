...
@XmlRootElement(name = "CobroCODIConsumoRequest", namespace = DetiPOSPort.DPOS_WS_NAMESPACE)
@Data
public class CobroCODIConsumoRequest {
    ...
    @XmlElement(name = "telefono", required = false, namespace = DetiPOSPort.DPOS_WS_NAMESPACE)
