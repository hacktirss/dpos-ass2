 ...
 * @author ROLANDO
 */
public class GetLogoAction extends BaseAction {

    public GetLogoAction(DinamicVO<String, String> param) throws DetiPOSFault {
        super(param);
    }
    @Override
    ...
    private Comprobante getEncodedLogo() throws DetiPOSFault {
        ...
        try {
            ...
            POSConfigDAO.getConfiguration("PNG").forEach(item -> {
