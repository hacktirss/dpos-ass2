...
@XmlType(name = "", propOrder = { "idTerminal", "posicion", "password" })
@XmlRootElement(name = "CobroTarjetaPosicionRequest", namespace = DetiPOSPort.DPOS_WS_NAMESPACE)
@Data
public class CobroTarjetaPosicionRequest {
...
}//RecuperaUltimosConsumosRequest
