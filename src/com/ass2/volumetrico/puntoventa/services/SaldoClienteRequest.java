...
@XmlRootElement(name = "SaldoClienteRequest", namespace = DetiPOSPort.DPOS_WS_NAMESPACE)
@Data
public class SaldoClienteRequest {

    @XmlElement(name = "idTerminal", required = true, namespace = DetiPOSPort.DPOS_WS_NAMESPACE)
    protected String idTerminal;

    @XmlElement(name = "cliente", required = false, namespace = DetiPOSPort.DPOS_WS_NAMESPACE)
